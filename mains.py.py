...
## https://analyticsindiamag.com/building-a-covid-19-dashboard-using-streamlit/#:~:text=%20Building%20a%20Covid-19%20Dashboard%20using%20Streamlit%20,be%20the%20fastest-growing%20Machine%20Learning%20and...%20More%20


# While making dashboards using streamlit you will realize that displays the changes as soon as you save them which helps in visualizing them simultaneously and saves a lot of time. This dashboard is just an example of what streamlit can do, you can try creating streamlit dashboards with your dataset and make visually appealing charts and graphs.
# 
# Now let us have a look at the Dashboard we have created. For running our dashboard we need to run a python script using streamlit. I saved my file named ‘covid.py’. You can choose whatever name you want and launch it by running the below command in the Anaconda command prompt.
